        ...
        this.state = {
            projects: {
                "PICKO-Dapp": {
                    ...
                    desc: "Web application, built with React Typescript, Leaflet Open source map, Truffle, Solidity, Vite, Express TS, PostgreSQL, Prisma, JWT, PM2 cluster mode, and Socket.io",
